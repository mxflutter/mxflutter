...
```
  dependencies:
    mxflutter:https://github.com/mxflutter
      git:
...
例如：有两个业务文件 bundle-example1.js 和 bundle-example2.js，操作步骤如下：
1. 新建两个文件夹，名称分别是 example1 和 example2，将 js 文件放入对应文件夹；
2. 选中这两个文件夹，一并压缩成 bizBundle.zip。
