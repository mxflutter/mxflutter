define(['dart_sdk', 'packages/flutter/src/foundation/_bitfield_web', 'packages/flutter/src/gestures/arena', 'packages/flutter/gestures', 'packages/vector_math/vector_math_64'], function(dart_sdk, packages__flutter__src__foundation___bitfield_web, packages__flutter__src__gestures__arena, packages__flutter__gestures, packages__vector_math__vector_math_64) {
  ...
  text_style.TextStyle = class TextStyle extends diagnostics.Diagnosticable {
    ...
    copyWith(opts) {
      ...
      if (!(color == null || foreground == null)) dart.assertFailed(text_style._kColorForegroundWarning, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 721, 12, "t(color == null || foreground == nu");
      if (!(backgroundColor == null || background == null)) dart.assertFailed(text_style._kColorBackgroundWarning, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 722, 12, "t(backgroundColor == null || background == nu");
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 724, 12, "t(() {\n      if (this.debugLabel != null)\n        newDebugLabel = debugLabel ?? '(${this.debugLabel}).copyWith';\n      return true;\n    }");
    ...
    apply(opts) {
      ...
      if (!(fontSizeFactor != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 804, 12, "t(fontSizeFactor != nu");
      if (!(fontSizeDelta != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 805, 12, "t(fontSizeDelta != nu");
      if (!(this.fontSize != null || fontSizeFactor === 1.0 && fontSizeDelta === 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 806, 12, "t(fontSize != null || (fontSizeFactor == 1.0 && fontSizeDelta == 0.");
      if (!(fontWeightDelta != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 807, 12, "t(fontWeightDelta != nu");
      if (!(this.fontWeight != null || fontWeightDelta === 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 808, 12, "t(fontWeight != null || fontWeightDelta == 0");
      if (!(letterSpacingFactor != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 809, 12, "t(letterSpacingFactor != nu");
      if (!(letterSpacingDelta != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 810, 12, "t(letterSpacingDelta != nu");
      if (!(this.letterSpacing != null || letterSpacingFactor === 1.0 && letterSpacingDelta === 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 811, 12, "t(letterSpacing != null || (letterSpacingFactor == 1.0 && letterSpacingDelta == 0.");
      if (!(wordSpacingFactor != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 812, 12, "t(wordSpacingFactor != nu");
      if (!(wordSpacingDelta != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 813, 12, "t(wordSpacingDelta != nu");
      if (!(this.wordSpacing != null || wordSpacingFactor === 1.0 && wordSpacingDelta === 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 814, 12, "t(wordSpacing != null || (wordSpacingFactor == 1.0 && wordSpacingDelta == 0.");
      if (!(heightFactor != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 815, 12, "t(heightFactor != nu");
      if (!(heightDelta != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 816, 12, "t(heightDelta != nu");
      if (!(heightFactor != null || heightFactor === 1.0 && heightDelta === 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 817, 12, "t(heightFactor != null || (heightFactor == 1.0 && heightDelta == 0.");
      if (!(decorationThicknessFactor != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 818, 12, "t(decorationThicknessFactor != nu");
      if (!(decorationThicknessDelta != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 819, 12, "t(decorationThicknessDelta != nu");
      if (!(this.decorationThickness != null || decorationThicknessFactor === 1.0 && decorationThicknessDelta === 0.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 820, 12, "t(decorationThickness != null || (decorationThicknessFactor == 1.0 && decorationThicknessDelta == 0.");
      let modifiedDebugLabel = null;
      if (!dart.test(dart.fn(() => {
        if (this.debugLabel != null) modifiedDebugLabel = "(" + dart.str(this.debugLabel) + ").apply";
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 823, 12, "t(() {\n      if (debugLabel != null)\n        modifiedDebugLabel = '($debugLabel).apply';\n      return true;\n    }");
    ...
    merge(other) {
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 883, 12, "t(() {\n      if (other.debugLabel != null || debugLabel != null)\n        mergedDebugLabel = '(${debugLabel ?? _kDefaultDebugLabel}).merge(${other.debugLabel ?? _kDefaultDebugLabel})';\n      return true;\n    }");
    ...
    static lerp(a, b, t) {
      ...
      if (!(t != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 928, 12, "t(t != nu");
      if (!(a == null || b == null || dart.equals(a.inherit, b.inherit))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 929, 12, "t(a == null || b == null || a.inherit == b.inher");
      if (a == null && b == null) {
        return null;
      }
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 935, 12, "t(() {\n      lerpDebugLabel = 'lerp(${a?.debugLabel ?? _kDefaultDebugLabel} ⎯${t.toStringAsFixed(1)}→ ${b?.debugLabel ?? _kDefaultDebugLabel})';\n      return true;\n ");
      if (a == null) {
    ...
    getParagraphStyle(opts) {
      ...
      if (!(textScaleFactor != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 1078, 12, "ssert(textScaleFactor !");
      if (!(maxLines == null || dart.notNull(maxLines) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 1079, 12, "ssert(maxLines == null || maxLin");
    ...
    debugFillProperties(properties, opts) {
      ...
      if (this.decoration != null || this.decorationColor != null || this.decorationStyle != null || this.decorationThickness != null) {
        ...
        if (!dart.test(decorationDescription[$isNotEmpty])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 1252, 14, "ssert(decorationDescription.isNo");
  ...
  (text_style.TextStyle.new = function(opts) {
    ...
    if (!(inherit != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 427, 15, "t(inherit != nu");
    if (!(color == null || foreground == null)) dart.assertFailed(text_style._kColorForegroundWarning, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 428, 15, "t(color == null || foreground == nu");
    if (!(backgroundColor == null || background == null)) dart.assertFailed(text_style._kColorBackgroundWarning, "org-dartlang-app:///packages/flutter/src/painting/text_style.dart", 429, 15, "t(backgroundColor == null || background == nu");
  ...
  text_span.TextSpan = class TextSpan extends inline_span.InlineSpan {
    ...
    visitTextSpan(visitor) {
      ...
      if (this.children != null) {
        for (let child of this.children) {
          if (!text_span.TextSpan.is(child)) dart.assertFailed("visitTextSpan is deprecated. Use visitChildren to support InlineSpans", "org-dartlang-app:///packages/flutter/src/painting/text_span.dart", 258, 11, "child is TextSpan");
    ...
    computeToPlainText(buffer, opts) {
      let includeSemanticsLabels = opts && 'includeSemanticsLabels' in opts ? opts.includeSemanticsLabels : true;
      let includePlaceholders = opts && 'includePlaceholders' in opts ? opts.includePlaceholders : true;
      if (!dart.test(this.debugAssertIsValid())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_span.dart", 293, 12, "debugAssertIsValid()");
    ...
    computeSemanticsInformation(collector) {
      if (!dart.test(this.debugAssertIsValid())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_span.dart", 311, 12, "debugAssertIsValid()");
      ...
      if (!dart.test(dart.fn(() => {
        if (this.children != null) {
          for (let child of this.children) {
            ...
            if (!dart.test(child.debugAssertIsValid())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_span.dart", 374, 18, "child.debugAssertIsValid()");
          }
        }
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/text_span.dart", 362, 12, "() {\n      if (children != null) {\n        for (InlineSpan child in children) {\n          if (child == null) {\n            throw FlutterError.fromParts(<DiagnosticsNode>[\n              ErrorSummary('TextSpan contains a null child.'),\n              ErrorDescription(\n                  'A TextSpan object with a non-null child list should not have any nulls in its child list.'),\n              toDiagnosticsNode(name: 'The full text in question was',\n                  style: DiagnosticsTreeStyle.errorProperty),\n            ]);\n          }\n          assert(child.debugAssertIsValid());\n        }\n      }\n      return true;\n    }()");
      return super.debugAssertIsValid();
    }
    compareTo(other) {
      let t17, t17$;
  ...
  matrix_utils.MatrixUtils = class MatrixUtils extends core.Object {
    ...
    static createCylindricalProjectionTransform(opts) {
      ...
      if (!(radius != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 481, 12, "rt(radius != n");
      if (!(angle != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 482, 12, "rt(angle != n");
      if (!(dart.notNull(perspective) >= 0 && dart.notNull(perspective) <= 1.0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 483, 12, "rt(perspective >= 0 && perspective <= ");
      if (!(orientation != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 484, 12, "rt(orientation != n");
  ...
  (matrix_utils.TransformProperty.new = function(name, value, opts) {
    ...
    let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : C84 || CT.C84;
    let level = opts && 'level' in opts ? opts.level : C86 || CT.C86;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 554, 15, "rt(showName != n");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/painting/matrix_utils.dart", 555, 15, "rt(level != n");
