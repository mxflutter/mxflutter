...
(vv_my_history_view._VVMyHistoryPageState.new = function() {
  ...
  this.cellModels = JSArrayOfVVMyHistoryPageCellModel().of([new vv_my_history_model.VVMyHistoryPageCellModel.new({coverImageUrl: "http://qqpublic.qpic.cn/qq_public_cover/0/0-2863332478-FA84F501A8430EF1B1B438AD0DB0932C_vsmcut/0", title: "王思聪被取消限制消费令", duration: "01:33", sectionTitle: "5小时前", section: 0, row: 0}), new vv_my_history_model.VVMyHistoryPageCellModel.new({coverImageUrl: "http://qqpublic.qpic.cn/qq_public_cover/0/0-2863332478-FA84F501A8430EF1B1B438AD0DB0932C_vsmcut/0", title: "滴滴顺风车回复运行首日, 乘客等半小时没车, 客服: 审核严格 车, 客服: 审核严格车, 客服: 审核严格车, 客服: 审核严格车, 客服: 审核严格车, 客服: 审核严格", duration: "01:41", sectionTitle: "7天前fs", section: 1, row: 0}), new vv_my_history_model.VVMyHistoryPageCellModel.new({coverImageUrl: "http://qqpublic.qpic.cn/qq_public_cover/0/0-2863332478-FA84F501A8430EF1B1B438AD0DB0932C_vsmcut/0", title: "过程中，可以通过鼠标指针，实时查看指定的对象的值", duration: "01:42", sectionTitle: "7天前fs", section: 1, row: 1})]);
