...
const article = Object.create(dart.library);
let JSArrayOfArticle = () => (JSArrayOfArticle = dart.constFn(_interceptors.JSArray$(article.Article)))();
const CT = Object.create(null);
const headUrl$ = dart.privateName(article, "Article.headUrl");
const user$ = dart.privateName(article, "Article.user");
const action$ = dart.privateName(article, "Article.action");
const time$ = dart.privateName(article, "Article.time");
const title$ = dart.privateName(article, "Article.title");
const mark$ = dart.privateName(article, "Article.mark");
const imgUrl$ = dart.privateName(article, "Article.imgUrl");
const agreeNum$ = dart.privateName(article, "Article.agreeNum");
const commentNum$ = dart.privateName(article, "Article.commentNum");
...
;
dart.setLibraryUri(article.Article, "package:zhihu/home/article.dart");
;
...
//# sourceMappingURL=article.ddc.js.map
