...
const question = Object.create(dart.library);
let JSArrayOfQuestion = () => (JSArrayOfQuestion = dart.constFn(_interceptors.JSArray$(question.Question)))();
const CT = Object.create(null);
const order$ = dart.privateName(question, "Question.order");
const rise$ = dart.privateName(question, "Question.rise");
const title$ = dart.privateName(question, "Question.title");
const mark$ = dart.privateName(question, "Question.mark");
const hotNum$ = dart.privateName(question, "Question.hotNum");
const imgUrl$ = dart.privateName(question, "Question.imgUrl");
...
;
dart.setLibraryUri(question.Question, "package:zhihu/home/question.dart");
;
...
//# sourceMappingURL=question.ddc.js.map
