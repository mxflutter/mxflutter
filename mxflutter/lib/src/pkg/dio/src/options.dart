...
var _responseType = MXFunctionInvoke(
    "ResponseType",
    ({String name, int index}) => MXResponseType.parse(name, index), ["name","index"]
  );
...
var _requestOptions = MXFunctionInvoke(
    ...
    (
      ...
      queryParameters: toMapT<String, dynamic>(queryParameters),
      baseUrl: baseUrl,
      onReceiveProgress: createVoidTwoParamsClosure<int, int>(_requestOptions.buildOwner, onReceiveProgress),
      onSendProgress: createVoidTwoParamsClosure<int, int>(_requestOptions.buildOwner, onSendProgress),
      cancelToken: cancelToken,
      extra: toMapT<String, dynamic>(extra),
      headers: toMapT<String, dynamic>(headers),
      responseType: responseType,
