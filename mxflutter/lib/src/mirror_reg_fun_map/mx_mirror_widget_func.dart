...
import 'package:mxflutter/src/pkg/flutter_inappwebview/flutter_inappwebview.dart';
...
import 'package:mxflutter/src/widgets/src/packages/vector_math/vector_math_64.dart';
...
void mxRegisterThirdPartyWidgetFunc() {
  ...
  MXMirror.getInstance()
      .registerFunctions(registerFlutterInappwebviewLibrarySeries());
}
