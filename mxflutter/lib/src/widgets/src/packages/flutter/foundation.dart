...
import 'src/foundation/_platform_io.dart';
import 'src/foundation/basic_types.dart';
import 'src/foundation/binding.dart';
import 'src/foundation/_bitfield_io.dart';
...
import 'src/foundation/_isolates_io.dart';
...
Map<String, MXFunctionInvoke> registerFoundationLibrarySeries() {
  ...
  m.addAll(registerPlatformIoSeries());
  m.addAll(registerBasicTypesSeries());
  m.addAll(registerBindingSeries());
  m.addAll(registerBitfieldIoSeries());
  ...
  m.addAll(registerIsolatesIoSeries());
