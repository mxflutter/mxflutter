...
Map<String, MXFunctionInvoke> registerShiftedBoxSeries() {
  ...
  m[_renderFractionallySizedOverflowBox.funName] =
      _renderFractionallySizedOverflowBox;
  m[_renderCustomSingleChildLayoutBox.funName] =
      _renderCustomSingleChildLayoutBox;
