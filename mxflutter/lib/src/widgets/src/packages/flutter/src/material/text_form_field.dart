...
var _textFormField = MXFunctionInvoke(
  ...
  ({
    ...
    onChanged: createValueChangedGenericClosure<String>(
        _textFormField.buildOwner, onChanged),
    onTap: createVoidCallbackClosure(_textFormField.buildOwner, onTap),
    onEditingComplete:
        createVoidCallbackClosure(_textFormField.buildOwner, onEditingComplete),
    onFieldSubmitted: createValueChangedGenericClosure<String>(
        _textFormField.buildOwner, onFieldSubmitted),
    onSaved: createValueChangedGenericClosure<String>(
        _textFormField.buildOwner, onSaved),
    validator: null,
