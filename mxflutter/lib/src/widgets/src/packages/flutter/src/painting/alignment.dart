...
Map<String, MXFunctionInvoke> registerAlignmentSeries() {
  ...
  m[_alignmentDirectional_centerStart.funName] = _alignmentDirectional_centerStart;
  ...
  m[_alignmentDirectional_bottomStart.funName] = _alignmentDirectional_bottomStart;
  m[_alignmentDirectional_bottomCenter.funName] = _alignmentDirectional_bottomCenter;
...
var _alignment_topLeft = MXFunctionInvoke(
  "Alignment.topLeft",
    (
    ) =>
      Alignment.topLeft
);
var _alignment_topCenter = MXFunctionInvoke(
  "Alignment.topCenter",
    (
    ) =>
      Alignment.topCenter
);
var _alignment_topRight = MXFunctionInvoke(
  "Alignment.topRight",
    (
    ) =>
      Alignment.topRight
);
var _alignment_centerLeft = MXFunctionInvoke(
  "Alignment.centerLeft",
    (
    ) =>
      Alignment.centerLeft
);
var _alignment_center = MXFunctionInvoke(
  "Alignment.center",
    (
    ) =>
      Alignment.center
);
var _alignment_centerRight = MXFunctionInvoke(
  "Alignment.centerRight",
    (
    ) =>
      Alignment.centerRight
);
var _alignment_bottomLeft = MXFunctionInvoke(
  "Alignment.bottomLeft",
    (
    ) =>
      Alignment.bottomLeft
);
var _alignment_bottomCenter = MXFunctionInvoke(
  "Alignment.bottomCenter",
    (
    ) =>
      Alignment.bottomCenter
);
var _alignment_bottomRight = MXFunctionInvoke(
...
var _textAlignVertical_top = MXFunctionInvoke(
