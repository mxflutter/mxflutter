...
Map<String, MXFunctionInvoke> registerPointerRouterSeries() {
  ...
  m[_flutterErrorDetailsForPointerRouter.funName] =
      _flutterErrorDetailsForPointerRouter;
  return m;
}
...
var _flutterErrorDetailsForPointerRouter = MXFunctionInvoke(
  ...
  ({
    ...
    context: context,
    router: router,
    route: createValueChangedGenericClosure<PointerEvent>(
        _flutterErrorDetailsForPointerRouter.buildOwner, route),
    event: event,
