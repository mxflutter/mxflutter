...
var _popupMenuButton = MXFunctionInvoke(
  ...
  ({
    ...
    onSelected: createValueChangedGenericClosure<dynamic>(
        _popupMenuButton.buildOwner, onSelected),
    onCanceled:
        createVoidCallbackClosure(_popupMenuButton.buildOwner, onCanceled),
    tooltip: tooltip,
