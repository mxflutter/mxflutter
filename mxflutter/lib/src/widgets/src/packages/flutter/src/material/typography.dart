...
var _typography_blackRedmond = MXFunctionInvoke(
  "Typography.blackRedmond",
    (
    ) =>
      Typography.blackRedmond
);
var _typography_whiteRedmond = MXFunctionInvoke(
...
var _typography_dense2014 = MXFunctionInvoke(
  "Typography.dense2014",
    (
    ) =>
      Typography.dense2014
);
var _typography_dense2018 = MXFunctionInvoke(
  "Typography.dense2018",
    (
    ) =>
      Typography.dense2018
);
var _typography_tall2014 = MXFunctionInvoke(
  "Typography.tall2014",
    (
    ) =>
      Typography.tall2014
);
var _typography_tall2018 = MXFunctionInvoke(
  "Typography.tall2018",
    (
    ) =>
      Typography.tall2018
