...
var _calendarDateRangePicker = MXFunctionInvoke(
  ...
  ({
    ...
    onStartDateChanged: createValueChangedGenericClosure<DateTime>(
        _calendarDateRangePicker.buildOwner, onStartDateChanged),
    onEndDateChanged: createValueChangedGenericClosure<DateTime>(
        _calendarDateRangePicker.buildOwner, onEndDateChanged),
  ),
  [
    "key",
    "initialStartDate",
