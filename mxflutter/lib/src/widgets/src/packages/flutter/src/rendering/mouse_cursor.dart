...
Map<String, MXFunctionInvoke> registerMouseCursorSeries() {
  ...
  m[_systemMouseCursorsHorizontalDoubleArrow.funName] =
      _systemMouseCursorsHorizontalDoubleArrow;
  m[_systemMouseCursorsVerticalDoubleArrow.funName] =
      _systemMouseCursorsVerticalDoubleArrow;
  return m;
}

var _mouseCursorDefer =
    MXFunctionInvoke("MouseCursor.defer", () => MouseCursor.defer);
var _mouseCursorUncontrolled = MXFunctionInvoke(
    "MouseCursor.uncontrolled", () => MouseCursor.uncontrolled);
var _systemMouseCursorsNone =
    MXFunctionInvoke("SystemMouseCursors.none", () => SystemMouseCursors.none);
var _systemMouseCursorsBasic = MXFunctionInvoke(
    "SystemMouseCursors.basic", () => SystemMouseCursors.basic);
var _systemMouseCursorsClick = MXFunctionInvoke(
    "SystemMouseCursors.click", () => SystemMouseCursors.click);
var _systemMouseCursorsText =
    MXFunctionInvoke("SystemMouseCursors.text", () => SystemMouseCursors.text);
var _systemMouseCursorsForbidden = MXFunctionInvoke(
    "SystemMouseCursors.forbidden", () => SystemMouseCursors.forbidden);
var _systemMouseCursorsGrab =
    MXFunctionInvoke("SystemMouseCursors.grab", () => SystemMouseCursors.grab);
var _systemMouseCursorsGrabbing = MXFunctionInvoke(
    "SystemMouseCursors.grabbing", () => SystemMouseCursors.grabbing);
var _systemMouseCursorsHorizontalDoubleArrow = MXFunctionInvoke(
    "SystemMouseCursors.horizontalDoubleArrow",
    () => SystemMouseCursors.horizontalDoubleArrow);
var _systemMouseCursorsVerticalDoubleArrow = MXFunctionInvoke(
