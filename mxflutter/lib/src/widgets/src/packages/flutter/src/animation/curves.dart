...
var _curves_linear = MXFunctionInvoke(
  "Curves.linear",
    (
    ) =>
      Curves.linear
);
var _curves_decelerate = MXFunctionInvoke(
  "Curves.decelerate",
    (
    ) =>
      Curves.decelerate
...
var _curves_ease = MXFunctionInvoke(
  "Curves.ease",
    (
    ) =>
      Curves.ease
);
var _curves_easeIn = MXFunctionInvoke(
  "Curves.easeIn",
    (
    ) =>
      Curves.easeIn
);
var _curves_easeInToLinear = MXFunctionInvoke(
  "Curves.easeInToLinear",
    (
    ) =>
      Curves.easeInToLinear
);
var _curves_easeInSine = MXFunctionInvoke(
  "Curves.easeInSine",
    (
    ) =>
      Curves.easeInSine
);
var _curves_easeInQuad = MXFunctionInvoke(
  "Curves.easeInQuad",
    (
    ) =>
      Curves.easeInQuad
);
var _curves_easeInCubic = MXFunctionInvoke(
  "Curves.easeInCubic",
    (
    ) =>
      Curves.easeInCubic
);
var _curves_easeInQuart = MXFunctionInvoke(
  "Curves.easeInQuart",
    (
    ) =>
      Curves.easeInQuart
);
var _curves_easeInQuint = MXFunctionInvoke(
  "Curves.easeInQuint",
    (
    ) =>
      Curves.easeInQuint
);
var _curves_easeInExpo = MXFunctionInvoke(
  "Curves.easeInExpo",
    (
    ) =>
      Curves.easeInExpo
);
var _curves_easeInCirc = MXFunctionInvoke(
  "Curves.easeInCirc",
    (
    ) =>
      Curves.easeInCirc
);
var _curves_easeInBack = MXFunctionInvoke(
  "Curves.easeInBack",
    (
    ) =>
      Curves.easeInBack
);
var _curves_easeOut = MXFunctionInvoke(
  "Curves.easeOut",
    (
    ) =>
      Curves.easeOut
);
var _curves_linearToEaseOut = MXFunctionInvoke(
  "Curves.linearToEaseOut",
    (
    ) =>
      Curves.linearToEaseOut
);
var _curves_easeOutSine = MXFunctionInvoke(
  "Curves.easeOutSine",
    (
    ) =>
      Curves.easeOutSine
);
var _curves_easeOutQuad = MXFunctionInvoke(
  "Curves.easeOutQuad",
    (
    ) =>
      Curves.easeOutQuad
);
var _curves_easeOutCubic = MXFunctionInvoke(
  "Curves.easeOutCubic",
    (
    ) =>
      Curves.easeOutCubic
);
var _curves_easeOutQuart = MXFunctionInvoke(
  "Curves.easeOutQuart",
    (
    ) =>
      Curves.easeOutQuart
);
var _curves_easeOutQuint = MXFunctionInvoke(
  "Curves.easeOutQuint",
    (
    ) =>
      Curves.easeOutQuint
);
var _curves_easeOutExpo = MXFunctionInvoke(
  "Curves.easeOutExpo",
    (
    ) =>
      Curves.easeOutExpo
);
var _curves_easeOutCirc = MXFunctionInvoke(
  "Curves.easeOutCirc",
    (
    ) =>
      Curves.easeOutCirc
);
var _curves_easeOutBack = MXFunctionInvoke(
  "Curves.easeOutBack",
    (
    ) =>
      Curves.easeOutBack
);
var _curves_easeInOut = MXFunctionInvoke(
  "Curves.easeInOut",
    (
    ) =>
      Curves.easeInOut
);
var _curves_easeInOutSine = MXFunctionInvoke(
  "Curves.easeInOutSine",
    (
    ) =>
      Curves.easeInOutSine
);
var _curves_easeInOutQuad = MXFunctionInvoke(
  "Curves.easeInOutQuad",
    (
    ) =>
      Curves.easeInOutQuad
);
var _curves_easeInOutCubic = MXFunctionInvoke(
  "Curves.easeInOutCubic",
    (
    ) =>
      Curves.easeInOutCubic
);
var _curves_easeInOutQuart = MXFunctionInvoke(
  "Curves.easeInOutQuart",
    (
    ) =>
      Curves.easeInOutQuart
);
var _curves_easeInOutQuint = MXFunctionInvoke(
  "Curves.easeInOutQuint",
    (
    ) =>
      Curves.easeInOutQuint
);
var _curves_easeInOutExpo = MXFunctionInvoke(
  "Curves.easeInOutExpo",
    (
    ) =>
      Curves.easeInOutExpo
);
var _curves_easeInOutCirc = MXFunctionInvoke(
  "Curves.easeInOutCirc",
    (
    ) =>
      Curves.easeInOutCirc
);
var _curves_easeInOutBack = MXFunctionInvoke(
  "Curves.easeInOutBack",
    (
    ) =>
      Curves.easeInOutBack
);
var _curves_fastOutSlowIn = MXFunctionInvoke(
  "Curves.fastOutSlowIn",
    (
    ) =>
      Curves.fastOutSlowIn
);
var _curves_slowMiddle = MXFunctionInvoke(
  "Curves.slowMiddle",
    (
    ) =>
      Curves.slowMiddle
);
var _curves_bounceIn = MXFunctionInvoke(
  "Curves.bounceIn",
    (
    ) =>
      Curves.bounceIn
);
var _curves_bounceOut = MXFunctionInvoke(
  "Curves.bounceOut",
    (
    ) =>
      Curves.bounceOut
);
var _curves_bounceInOut = MXFunctionInvoke(
  "Curves.bounceInOut",
    (
    ) =>
      Curves.bounceInOut
);
var _curves_elasticIn = MXFunctionInvoke(
  "Curves.elasticIn",
    (
    ) =>
      Curves.elasticIn
);
var _curves_elasticOut = MXFunctionInvoke(
  "Curves.elasticOut",
    (
    ) =>
      Curves.elasticOut
);
var _curves_elasticInOut = MXFunctionInvoke(
  "Curves.elasticInOut",
    (
    ) =>
      Curves.elasticInOut
