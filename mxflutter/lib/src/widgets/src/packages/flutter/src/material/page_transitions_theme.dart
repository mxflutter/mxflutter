...
Map<String, MXFunctionInvoke> registerPageTransitionsThemeSeries() {
  ...
  m[_fadeUpwardsPageTransitionsBuilder.funName] =
      _fadeUpwardsPageTransitionsBuilder;
  m[_openUpwardsPageTransitionsBuilder.funName] =
      _openUpwardsPageTransitionsBuilder;
  m[_zoomPageTransitionsBuilder.funName] = _zoomPageTransitionsBuilder;
  m[_cupertinoPageTransitionsBuilder.funName] =
      _cupertinoPageTransitionsBuilder;
