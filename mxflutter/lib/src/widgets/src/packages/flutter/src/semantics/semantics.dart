...
var _semanticsProperties = MXFunctionInvoke(
  ...
  ({
    ...
    onLongPress:
        createVoidCallbackClosure(_semanticsProperties.buildOwner, onLongPress),
    onScrollLeft: createVoidCallbackClosure(
        _semanticsProperties.buildOwner, onScrollLeft),
    onScrollRight: createVoidCallbackClosure(
        _semanticsProperties.buildOwner, onScrollRight),
    onScrollUp:
        createVoidCallbackClosure(_semanticsProperties.buildOwner, onScrollUp),
    onScrollDown: createVoidCallbackClosure(
        _semanticsProperties.buildOwner, onScrollDown),
    onIncrease:
        createVoidCallbackClosure(_semanticsProperties.buildOwner, onIncrease),
    onDecrease:
        createVoidCallbackClosure(_semanticsProperties.buildOwner, onDecrease),
    ...
    onPaste:
        createVoidCallbackClosure(_semanticsProperties.buildOwner, onPaste),
    onMoveCursorForwardByCharacter: createValueChangedGenericClosure<bool>(
        _semanticsProperties.buildOwner, onMoveCursorForwardByCharacter),
    onMoveCursorBackwardByCharacter: createValueChangedGenericClosure<bool>(
        _semanticsProperties.buildOwner, onMoveCursorBackwardByCharacter),
    onMoveCursorForwardByWord: createValueChangedGenericClosure<bool>(
        _semanticsProperties.buildOwner, onMoveCursorForwardByWord),
    onMoveCursorBackwardByWord: createValueChangedGenericClosure<bool>(
        _semanticsProperties.buildOwner, onMoveCursorBackwardByWord),
    onSetSelection: createValueChangedGenericClosure<TextSelection>(
        _semanticsProperties.buildOwner, onSetSelection),
    onDidGainAccessibilityFocus: createVoidCallbackClosure(
        _semanticsProperties.buildOwner, onDidGainAccessibilityFocus),
    onDidLoseAccessibilityFocus: createVoidCallbackClosure(
        _semanticsProperties.buildOwner, onDidLoseAccessibilityFocus),
    onDismiss:
        createVoidCallbackClosure(_semanticsProperties.buildOwner, onDismiss),
...
var _semanticsNode = MXFunctionInvoke(
  ...
  ({
    ...
    key: key,
    showOnScreen:
        createVoidCallbackClosure(_semanticsNode.buildOwner, showOnScreen),
  ),
  [
    "key",
    "showOnScreen",
