...
Map<String, MXFunctionInvoke> registerRawKeyboardFuchsiaSeries() {
  ...
  m[_rawKeyEventDataFuchsia_modifierNone.funName] = _rawKeyEventDataFuchsia_modifierNone;
  m[_rawKeyEventDataFuchsia_modifierCapsLock.funName] = _rawKeyEventDataFuchsia_modifierCapsLock;
  m[_rawKeyEventDataFuchsia_modifierLeftShift.funName] = _rawKeyEventDataFuchsia_modifierLeftShift;
  m[_rawKeyEventDataFuchsia_modifierRightShift.funName] = _rawKeyEventDataFuchsia_modifierRightShift;
  m[_rawKeyEventDataFuchsia_modifierShift.funName] = _rawKeyEventDataFuchsia_modifierShift;
  m[_rawKeyEventDataFuchsia_modifierLeftControl.funName] = _rawKeyEventDataFuchsia_modifierLeftControl;
  m[_rawKeyEventDataFuchsia_modifierRightControl.funName] = _rawKeyEventDataFuchsia_modifierRightControl;
  m[_rawKeyEventDataFuchsia_modifierControl.funName] = _rawKeyEventDataFuchsia_modifierControl;
  m[_rawKeyEventDataFuchsia_modifierLeftAlt.funName] = _rawKeyEventDataFuchsia_modifierLeftAlt;
  m[_rawKeyEventDataFuchsia_modifierRightAlt.funName] = _rawKeyEventDataFuchsia_modifierRightAlt;
  m[_rawKeyEventDataFuchsia_modifierAlt.funName] = _rawKeyEventDataFuchsia_modifierAlt;
  m[_rawKeyEventDataFuchsia_modifierLeftMeta.funName] = _rawKeyEventDataFuchsia_modifierLeftMeta;
  m[_rawKeyEventDataFuchsia_modifierRightMeta.funName] = _rawKeyEventDataFuchsia_modifierRightMeta;
  m[_rawKeyEventDataFuchsia_modifierMeta.funName] = _rawKeyEventDataFuchsia_modifierMeta;
  return m;
}
