...
var _textField = MXFunctionInvoke(
  ...
  ({
    ...
    onChanged: createValueChangedGenericClosure<String>(
        _textField.buildOwner, onChanged),
    onEditingComplete:
        createVoidCallbackClosure(_textField.buildOwner, onEditingComplete),
    onSubmitted: createValueChangedGenericClosure<String>(
        _textField.buildOwner, onSubmitted),
...
var _textField_noMaxLength =
    MXFunctionInvoke("TextField.noMaxLength", () => TextField.noMaxLength);
