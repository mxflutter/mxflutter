...
var _pipelineOwner = MXFunctionInvoke(
  ...
  ({
    ...
    dynamic onSemanticsOwnerDisposed,
      ...
      PipelineOwner(
    onNeedVisualUpdate: createVoidCallbackClosure(
        _pipelineOwner.buildOwner, onNeedVisualUpdate),
    onSemanticsOwnerCreated: createVoidCallbackClosure(
        _pipelineOwner.buildOwner, onSemanticsOwnerCreated),
    onSemanticsOwnerDisposed: createVoidCallbackClosure(
        _pipelineOwner.buildOwner, onSemanticsOwnerDisposed),
  ),
  [
    "onNeedVisualUpdate",
