...
class MXProxyTextTheme {
  ...
  static Map<String, MXFunctionInvoke> registerSeries() {
    ...
    m[cupertinoColors_.funName] = cupertinoColors_;
    ...
    m[cupertinoDynamicColor_.funName] = cupertinoDynamicColor_;
    return m;
  }
  static var cupertinoTextThemeData = MXFunctionInvoke(
  ...
  static var cupertinoTextThemeData_raw = MXFunctionInvoke(
  ...
  static var cupertinoIconThemeData = MXFunctionInvoke(
  ...
  static var cupertinoTheme = MXFunctionInvoke(
      "CupertinoTheme",
      ({
        Key key,
  ...
  static var cupertinoThemeData = MXFunctionInvoke(
      "CupertinoThemeData",
      ({
        Brightness brightness,
        Color primaryColor,
  ...
  static var cupertinoThemeData_raw = MXFunctionInvoke(
  ...
  static var cupertinoThemeData_rawWithDefaults = MXFunctionInvoke(
  ...
  static var cupertinoColors_ = MXFunctionInvoke(
    "cupertinoColors.",
      ({
      }) =>
        CupertinoColors.(
  ...
  static var cupertinoDynamicColor = MXFunctionInvoke(
  ...
  static var cupertinoDynamicColor_withBrightnessAndContrast = MXFunctionInvoke(
  ...
  static var cupertinoDynamicColor_withBrightness = MXFunctionInvoke(
  ...
  static var cupertinoDynamicColor_ = MXFunctionInvoke(
    "cupertinoDynamicColor.",
      ({
