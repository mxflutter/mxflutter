...
var _dropdownButton = MXFunctionInvoke(
  ...
  ({
    ...
    onChanged: createValueChangedGenericClosure<dynamic>(
        _dropdownButton.buildOwner, onChanged),
...
var _dropdownButtonFormField = MXFunctionInvoke(
  ...
  ({
    ...
    hint: hint,
    onChanged: createValueChangedGenericClosure<dynamic>(
        _dropdownButtonFormField.buildOwner, onChanged),
    onTap:
        createVoidCallbackClosure(_dropdownButtonFormField.buildOwner, onTap),
    decoration: decoration,
    onSaved: createValueChangedGenericClosure<dynamic>(
        _dropdownButtonFormField.buildOwner, onSaved),
    validator: null,
