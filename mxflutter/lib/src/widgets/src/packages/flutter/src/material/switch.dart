...
var _switch = MXFunctionInvoke(
    ...
    (
      ...
      onActiveThumbImageError: createVoidTwoParamsClosure<dynamic, StackTrace>(_switch.buildOwner, onActiveThumbImageError),
      inactiveThumbImage: inactiveThumbImage,
      onInactiveThumbImageError: createVoidTwoParamsClosure<dynamic, StackTrace>(_switch.buildOwner, onInactiveThumbImageError),
      materialTapTargetSize: materialTapTargetSize,
...
var _switch_adaptive = MXFunctionInvoke(
  "Switch.adaptive",
    (
      ...
      inactiveTrackColor: inactiveTrackColor,
      activeThumbImage: activeThumbImage,
      onActiveThumbImageError: createVoidTwoParamsClosure<dynamic, StackTrace>(_switch_adaptive.buildOwner, onActiveThumbImageError),
      inactiveThumbImage: inactiveThumbImage,
      onInactiveThumbImageError: createVoidTwoParamsClosure<dynamic, StackTrace>(_switch_adaptive.buildOwner, onInactiveThumbImageError),
      materialTapTargetSize: materialTapTargetSize,
      dragStartBehavior: dragStartBehavior,
      focusColor: focusColor,
      hoverColor: hoverColor,
