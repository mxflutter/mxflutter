...
Map<String, MXFunctionInvoke> registerSlidingSegmentedControlSeries() {
  ...
  m[_cupertinoSlidingSegmentedControl.funName] =
      _cupertinoSlidingSegmentedControl;
  return m;
}
...
var _cupertinoSlidingSegmentedControl = MXFunctionInvoke(
  ...
  ({
    ...
    Color thumbColor = const CupertinoDynamicColor.withBrightness(
        color: const Color(0xFFFFFFFF), darkColor: const Color(0xFF636366)),
    ...
    onValueChanged: createValueChangedGenericClosure<dynamic>(
        _cupertinoSlidingSegmentedControl.buildOwner, onValueChanged),
