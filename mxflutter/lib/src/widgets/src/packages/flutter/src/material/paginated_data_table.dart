...
Map<String, MXFunctionInvoke> registerPaginatedDataTableSeries() {
  ...
  m[_paginatedDataTableDefaultRowsPerPage.funName] =
      _paginatedDataTableDefaultRowsPerPage;
...
var _paginatedDataTable = MXFunctionInvoke(
  ...
  ({
    ...
    int rowsPerPage = 10,
    dynamic availableRowsPerPage = const <int>[10.0, 20.0, 50.0, 100.0],
    ...
    onSelectAll: createValueChangedGenericClosure<bool>(
        _paginatedDataTable.buildOwner, onSelectAll),
    ...
    onPageChanged: createValueChangedGenericClosure<int>(
        _paginatedDataTable.buildOwner, onPageChanged),
    rowsPerPage: rowsPerPage,
    availableRowsPerPage: toListT<int>(availableRowsPerPage),
    onRowsPerPageChanged: createValueChangedGenericClosure<int>(
        _paginatedDataTable.buildOwner, onRowsPerPageChanged),
...
var _paginatedDataTableDefaultRowsPerPage = MXFunctionInvoke(
