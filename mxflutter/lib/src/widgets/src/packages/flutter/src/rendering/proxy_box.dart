...
var _renderPointerListener = MXFunctionInvoke(
  ...
  ({
    ...
    RenderBox child,
      ...
      RenderPointerListener(
    onPointerDown: createValueChangedGenericClosure<PointerDownEvent>(
        _renderPointerListener.buildOwner, onPointerDown),
    onPointerMove: createValueChangedGenericClosure<PointerMoveEvent>(
        _renderPointerListener.buildOwner, onPointerMove),
    onPointerUp: createValueChangedGenericClosure<PointerUpEvent>(
        _renderPointerListener.buildOwner, onPointerUp),
    onPointerCancel: createValueChangedGenericClosure<PointerCancelEvent>(
        _renderPointerListener.buildOwner, onPointerCancel),
    onPointerSignal: createValueChangedGenericClosure<PointerSignalEvent>(
        _renderPointerListener.buildOwner, onPointerSignal),
    behavior: behavior,
    child: child,
  ),
  [
...
var _renderMouseRegion = MXFunctionInvoke(
  ...
  ({
    ...
    RenderBox child,
      ...
      RenderMouseRegion(
    onEnter: createValueChangedGenericClosure<PointerEnterEvent>(
        _renderMouseRegion.buildOwner, onEnter),
...
var _renderSemanticsGestureHandler = MXFunctionInvoke(
  ...
  ({
    ...
    dynamic scrollFactor = 0.8,
      ...
      RenderSemanticsGestureHandler(
    child: child,
    onTap: createVoidCallbackClosure(
        _renderSemanticsGestureHandler.buildOwner, onTap),
    onLongPress: createVoidCallbackClosure(
        _renderSemanticsGestureHandler.buildOwner, onLongPress),
...
var _renderSemanticsAnnotations = MXFunctionInvoke(
  ...
  ({
    ...
    sortKey: sortKey,
    onTap: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onTap),
    onDismiss: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onDismiss),
    onLongPress: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onLongPress),
    onScrollLeft: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onScrollLeft),
    onScrollRight: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onScrollRight),
    onScrollUp: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onScrollUp),
    onScrollDown: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onScrollDown),
    onIncrease: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onIncrease),
    onDecrease: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onDecrease),
    onCopy: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onCopy),
    onCut: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onCut),
    onPaste: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onPaste),
    onMoveCursorForwardByCharacter: createValueChangedGenericClosure<bool>(
        _renderSemanticsAnnotations.buildOwner, onMoveCursorForwardByCharacter),
    onMoveCursorBackwardByCharacter: createValueChangedGenericClosure<bool>(
        _renderSemanticsAnnotations.buildOwner,
        onMoveCursorBackwardByCharacter),
    onMoveCursorForwardByWord: createValueChangedGenericClosure<bool>(
        _renderSemanticsAnnotations.buildOwner, onMoveCursorForwardByWord),
    onMoveCursorBackwardByWord: createValueChangedGenericClosure<bool>(
        _renderSemanticsAnnotations.buildOwner, onMoveCursorBackwardByWord),
    onSetSelection: createValueChangedGenericClosure<TextSelection>(
        _renderSemanticsAnnotations.buildOwner, onSetSelection),
    onDidGainAccessibilityFocus: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onDidGainAccessibilityFocus),
    onDidLoseAccessibilityFocus: createVoidCallbackClosure(
        _renderSemanticsAnnotations.buildOwner, onDidLoseAccessibilityFocus),
    customSemanticsActions:
        toMapT<CustomSemanticsAction, void Function()>(customSemanticsActions),
  ),
  [
    "child",
    "container",
