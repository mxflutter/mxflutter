...
var _rangeSlider = MXFunctionInvoke(
  ...
  ({
    ...
    key: key,
    values: values,
    onChanged: createValueChangedGenericClosure<RangeValues>(
        _rangeSlider.buildOwner, onChanged),
    onChangeStart: createValueChangedGenericClosure<RangeValues>(
        _rangeSlider.buildOwner, onChangeStart),
    onChangeEnd: createValueChangedGenericClosure<RangeValues>(
        _rangeSlider.buildOwner, onChangeEnd),
    min: min?.toDouble(),
    max: max?.toDouble(),
    divisions: divisions,
    labels: labels,
