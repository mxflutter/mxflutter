...
var _widgetToRenderBoxAdapter = MXFunctionInvoke(
  ...
  ({
    ...
    dynamic onBuild,
      ...
      WidgetToRenderBoxAdapter(
    renderBox: renderBox,
    onBuild: createVoidCallbackClosure(
        _widgetToRenderBoxAdapter.buildOwner, onBuild),
  ),
  [
    "renderBox",
    "onBuild",
...
var _listener = MXFunctionInvoke(
  ...
  ({
    ...
    onPointerDown: createValueChangedGenericClosure<PointerDownEvent>(
        _listener.buildOwner, onPointerDown),
    onPointerMove: createValueChangedGenericClosure<PointerMoveEvent>(
        _listener.buildOwner, onPointerMove),
    onPointerEnter: createValueChangedGenericClosure<PointerEnterEvent>(
        _listener.buildOwner, onPointerEnter),
    onPointerExit: createValueChangedGenericClosure<PointerExitEvent>(
        _listener.buildOwner, onPointerExit),
    onPointerHover: createValueChangedGenericClosure<PointerHoverEvent>(
        _listener.buildOwner, onPointerHover),
    onPointerUp: createValueChangedGenericClosure<PointerUpEvent>(
        _listener.buildOwner, onPointerUp),
    onPointerCancel: createValueChangedGenericClosure<PointerCancelEvent>(
        _listener.buildOwner, onPointerCancel),
    onPointerSignal: createValueChangedGenericClosure<PointerSignalEvent>(
        _listener.buildOwner, onPointerSignal),
    behavior: behavior,
    child: child,
  ),
  [
...
var _mouseRegion = MXFunctionInvoke(
  ...
  ({
    ...
    onEnter: createValueChangedGenericClosure<PointerEnterEvent>(
        _mouseRegion.buildOwner, onEnter),
...
var _semantics = MXFunctionInvoke(
  ...
  ({
    ...
    onScrollLeft:
        createVoidCallbackClosure(_semantics.buildOwner, onScrollLeft),
    onScrollRight:
        createVoidCallbackClosure(_semantics.buildOwner, onScrollRight),
    onScrollUp: createVoidCallbackClosure(_semantics.buildOwner, onScrollUp),
    onScrollDown:
        createVoidCallbackClosure(_semantics.buildOwner, onScrollDown),
    ...
    onMoveCursorForwardByCharacter: createValueChangedGenericClosure<bool>(
        _semantics.buildOwner, onMoveCursorForwardByCharacter),
    onMoveCursorBackwardByCharacter: createValueChangedGenericClosure<bool>(
        _semantics.buildOwner, onMoveCursorBackwardByCharacter),
    onSetSelection: createValueChangedGenericClosure<TextSelection>(
        _semantics.buildOwner, onSetSelection),
    onDidGainAccessibilityFocus: createVoidCallbackClosure(
        _semantics.buildOwner, onDidGainAccessibilityFocus),
    onDidLoseAccessibilityFocus: createVoidCallbackClosure(
        _semantics.buildOwner, onDidLoseAccessibilityFocus),
