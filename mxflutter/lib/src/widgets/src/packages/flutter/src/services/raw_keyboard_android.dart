...
Map<String, MXFunctionInvoke> registerRawKeyboardAndroidSeries() {
  ...
  m[_rawKeyEventDataAndroid_modifierNone.funName] = _rawKeyEventDataAndroid_modifierNone;
  m[_rawKeyEventDataAndroid_modifierAlt.funName] = _rawKeyEventDataAndroid_modifierAlt;
  m[_rawKeyEventDataAndroid_modifierLeftAlt.funName] = _rawKeyEventDataAndroid_modifierLeftAlt;
  m[_rawKeyEventDataAndroid_modifierRightAlt.funName] = _rawKeyEventDataAndroid_modifierRightAlt;
  m[_rawKeyEventDataAndroid_modifierShift.funName] = _rawKeyEventDataAndroid_modifierShift;
  m[_rawKeyEventDataAndroid_modifierLeftShift.funName] = _rawKeyEventDataAndroid_modifierLeftShift;
  m[_rawKeyEventDataAndroid_modifierRightShift.funName] = _rawKeyEventDataAndroid_modifierRightShift;
  m[_rawKeyEventDataAndroid_modifierSym.funName] = _rawKeyEventDataAndroid_modifierSym;
  m[_rawKeyEventDataAndroid_modifierFunction.funName] = _rawKeyEventDataAndroid_modifierFunction;
  m[_rawKeyEventDataAndroid_modifierControl.funName] = _rawKeyEventDataAndroid_modifierControl;
  m[_rawKeyEventDataAndroid_modifierLeftControl.funName] = _rawKeyEventDataAndroid_modifierLeftControl;
  m[_rawKeyEventDataAndroid_modifierRightControl.funName] = _rawKeyEventDataAndroid_modifierRightControl;
  m[_rawKeyEventDataAndroid_modifierMeta.funName] = _rawKeyEventDataAndroid_modifierMeta;
  m[_rawKeyEventDataAndroid_modifierLeftMeta.funName] = _rawKeyEventDataAndroid_modifierLeftMeta;
  m[_rawKeyEventDataAndroid_modifierRightMeta.funName] = _rawKeyEventDataAndroid_modifierRightMeta;
  m[_rawKeyEventDataAndroid_modifierCapsLock.funName] = _rawKeyEventDataAndroid_modifierCapsLock;
  m[_rawKeyEventDataAndroid_modifierNumLock.funName] = _rawKeyEventDataAndroid_modifierNumLock;
  m[_rawKeyEventDataAndroid_modifierScrollLock.funName] = _rawKeyEventDataAndroid_modifierScrollLock;
  return m;
}
