...
Map<String, MXFunctionInvoke> registerGestureDetectorSeries() {
  ...
  m[_gestureRecognizerFactoryWithHandlers.funName] =
      _gestureRecognizerFactoryWithHandlers;
...
var _gestureRecognizerFactoryWithHandlers = MXFunctionInvoke(
  ...
  ({
    ...
    dynamic initializer,
      ...
      GestureRecognizerFactoryWithHandlers(
    null,
    createValueChangedGenericClosure<GestureRecognizer>(
...
var _gestureDetector = MXFunctionInvoke(
  ...
  ({
    ...
    onTapDown: createValueChangedGenericClosure<TapDownDetails>(
        _gestureDetector.buildOwner, onTapDown),
    onTapUp: createValueChangedGenericClosure<TapUpDetails>(
        _gestureDetector.buildOwner, onTapUp),
    ...
    onSecondaryTapUp: createValueChangedGenericClosure<TapUpDetails>(
        _gestureDetector.buildOwner, onSecondaryTapUp),
    onSecondaryTapCancel: createVoidCallbackClosure(
        _gestureDetector.buildOwner, onSecondaryTapCancel),
    onDoubleTap:
        createVoidCallbackClosure(_gestureDetector.buildOwner, onDoubleTap),
    onLongPress:
        createVoidCallbackClosure(_gestureDetector.buildOwner, onLongPress),
    onLongPressStart: createValueChangedGenericClosure<LongPressStartDetails>(
        _gestureDetector.buildOwner, onLongPressStart),
    ...
    onVerticalDragStart: createValueChangedGenericClosure<DragStartDetails>(
        _gestureDetector.buildOwner, onVerticalDragStart),
    onVerticalDragUpdate: createValueChangedGenericClosure<DragUpdateDetails>(
        _gestureDetector.buildOwner, onVerticalDragUpdate),
    onVerticalDragEnd: createValueChangedGenericClosure<DragEndDetails>(
        _gestureDetector.buildOwner, onVerticalDragEnd),
    onVerticalDragCancel: createVoidCallbackClosure(
        _gestureDetector.buildOwner, onVerticalDragCancel),
    onHorizontalDragDown: createValueChangedGenericClosure<DragDownDetails>(
        _gestureDetector.buildOwner, onHorizontalDragDown),
    onHorizontalDragStart: createValueChangedGenericClosure<DragStartDetails>(
        _gestureDetector.buildOwner, onHorizontalDragStart),
    onHorizontalDragUpdate: createValueChangedGenericClosure<DragUpdateDetails>(
        _gestureDetector.buildOwner, onHorizontalDragUpdate),
    onHorizontalDragEnd: createValueChangedGenericClosure<DragEndDetails>(
        _gestureDetector.buildOwner, onHorizontalDragEnd),
    onHorizontalDragCancel: createVoidCallbackClosure(
        _gestureDetector.buildOwner, onHorizontalDragCancel),
    onForcePressStart: createValueChangedGenericClosure<ForcePressDetails>(
        _gestureDetector.buildOwner, onForcePressStart),
    onForcePressPeak: createValueChangedGenericClosure<ForcePressDetails>(
        _gestureDetector.buildOwner, onForcePressPeak),
    onForcePressUpdate: createValueChangedGenericClosure<ForcePressDetails>(
        _gestureDetector.buildOwner, onForcePressUpdate),
    onForcePressEnd: createValueChangedGenericClosure<ForcePressDetails>(
        _gestureDetector.buildOwner, onForcePressEnd),
    onPanDown: createValueChangedGenericClosure<DragDownDetails>(
        _gestureDetector.buildOwner, onPanDown),
    onPanStart: createValueChangedGenericClosure<DragStartDetails>(
        _gestureDetector.buildOwner, onPanStart),
    onPanUpdate: createValueChangedGenericClosure<DragUpdateDetails>(
        _gestureDetector.buildOwner, onPanUpdate),
    onPanEnd: createValueChangedGenericClosure<DragEndDetails>(
        _gestureDetector.buildOwner, onPanEnd),
    onPanCancel:
        createVoidCallbackClosure(_gestureDetector.buildOwner, onPanCancel),
    onScaleStart: createValueChangedGenericClosure<ScaleStartDetails>(
        _gestureDetector.buildOwner, onScaleStart),
    onScaleUpdate: createValueChangedGenericClosure<ScaleUpdateDetails>(
        _gestureDetector.buildOwner, onScaleUpdate),
    onScaleEnd: createValueChangedGenericClosure<ScaleEndDetails>(
        _gestureDetector.buildOwner, onScaleEnd),
    behavior: behavior,
...
var _rawGestureDetector = MXFunctionInvoke(
  ...
  ({
    ...
    Widget child,
    dynamic gestures =
        const <Type, GestureRecognizerFactory<GestureRecognizer>>{},
    HitTestBehavior behavior,
    bool excludeFromSemantics = false,
    ...
    child: child,
    gestures:
        toMapT<Type, GestureRecognizerFactory<GestureRecognizer>>(gestures),
    behavior: behavior,
    excludeFromSemantics: excludeFromSemantics,
    semantics: semantics,
  ),
