...
var _inputChip = MXFunctionInvoke(
  ...
  ({
    ...
    selected: selected,
    isEnabled: isEnabled,
    onSelected: createValueChangedGenericClosure<bool>(
        _inputChip.buildOwner, onSelected),
    deleteIcon: deleteIcon,
...
var _choiceChip = MXFunctionInvoke(
  ...
  ({
    ...
    labelPadding: labelPadding,
    onSelected: createValueChangedGenericClosure<bool>(
        _choiceChip.buildOwner, onSelected),
    pressElevation: pressElevation?.toDouble(),
    selected: selected,
    selectedColor: selectedColor,
    disabledColor: disabledColor,
...
var _filterChip = MXFunctionInvoke(
  ...
  ({
    ...
    selected: selected,
    onSelected: createValueChangedGenericClosure<bool>(
        _filterChip.buildOwner, onSelected),
    pressElevation: pressElevation?.toDouble(),
    disabledColor: disabledColor,
    selectedColor: selectedColor,
    tooltip: tooltip,
...
var _rawChip = MXFunctionInvoke(
  ...
  ({
    ...
    onSelected:
        createValueChangedGenericClosure<bool>(_rawChip.buildOwner, onSelected),
    pressElevation: pressElevation?.toDouble(),
