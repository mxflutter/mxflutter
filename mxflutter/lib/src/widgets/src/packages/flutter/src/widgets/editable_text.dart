...
var _editableText = MXFunctionInvoke(
  ...
  ({
    ...
    onChanged: createValueChangedGenericClosure<String>(
        _editableText.buildOwner, onChanged),
    onEditingComplete:
        createVoidCallbackClosure(_editableText.buildOwner, onEditingComplete),
    onSubmitted: createValueChangedGenericClosure<String>(
        _editableText.buildOwner, onSubmitted),
    onSelectionChanged:
        createVoidTwoParamsClosure<TextSelection, SelectionChangedCause>(
            _editableText.buildOwner, onSelectionChanged),
