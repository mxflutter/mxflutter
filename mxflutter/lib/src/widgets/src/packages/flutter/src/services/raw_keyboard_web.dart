...
Map<String, MXFunctionInvoke> registerRawKeyboardWebSeries() {
  ...
  m[_rawKeyEventDataWeb_modifierNone.funName] = _rawKeyEventDataWeb_modifierNone;
  m[_rawKeyEventDataWeb_modifierShift.funName] = _rawKeyEventDataWeb_modifierShift;
  m[_rawKeyEventDataWeb_modifierAlt.funName] = _rawKeyEventDataWeb_modifierAlt;
  m[_rawKeyEventDataWeb_modifierControl.funName] = _rawKeyEventDataWeb_modifierControl;
  m[_rawKeyEventDataWeb_modifierMeta.funName] = _rawKeyEventDataWeb_modifierMeta;
  m[_rawKeyEventDataWeb_modifierNumLock.funName] = _rawKeyEventDataWeb_modifierNumLock;
  m[_rawKeyEventDataWeb_modifierCapsLock.funName] = _rawKeyEventDataWeb_modifierCapsLock;
  m[_rawKeyEventDataWeb_modifierScrollLock.funName] = _rawKeyEventDataWeb_modifierScrollLock;
  return m;
}
