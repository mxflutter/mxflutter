...
class MXProxyPlatformView {
  ...
  static var platformViewHitTestBehavior = MXFunctionInvoke(
      "PlatformViewHitTestBehavior",
      ({Map args}) => MXPlatformViewHitTestBehavior.parse(args),
  );
  static var renderAndroidView = MXFunctionInvoke(
      "RenderAndroidView",
      ({
  ...
  static var renderUiKitView = MXFunctionInvoke(
      "RenderUiKitView",
      ({
  ...
  static var platformViewRenderBox = MXFunctionInvoke(
