...
var _renderEditable = MXFunctionInvoke(
  ...
  ({
    ...
    selection: selection,
    offset: offset,
    onSelectionChanged: createVoidThreeParamsClosure<
        TextSelection,
        RenderEditable,
        SelectionChangedCause>(_renderEditable.buildOwner, onSelectionChanged),
    onCaretChanged: createValueChangedGenericClosure<Rect>(
        _renderEditable.buildOwner, onCaretChanged),
