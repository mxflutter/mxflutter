...
var _cupertinoDatePicker = MXFunctionInvoke(
  ...
  ({
    ...
    key: key,
    mode: mode,
    onDateTimeChanged: createValueChangedGenericClosure<DateTime>(
        _cupertinoDatePicker.buildOwner, onDateTimeChanged),
...
var _cupertinoTimerPicker = MXFunctionInvoke(
  ...
  ({
    ...
    alignment: alignment,
    backgroundColor: backgroundColor,
    onTimerDurationChanged: createValueChangedGenericClosure<Duration>(
        _cupertinoTimerPicker.buildOwner, onTimerDurationChanged),
  ),
  [
    "key",
    "mode",
