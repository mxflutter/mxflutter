...
var _inkResponse = MXFunctionInvoke(
  ...
  ({
    ...
    onTapDown: createValueChangedGenericClosure<TapDownDetails>(
        _inkResponse.buildOwner, onTapDown),
    onTapCancel:
        createVoidCallbackClosure(_inkResponse.buildOwner, onTapCancel),
    onDoubleTap:
        createVoidCallbackClosure(_inkResponse.buildOwner, onDoubleTap),
    onLongPress:
        createVoidCallbackClosure(_inkResponse.buildOwner, onLongPress),
    ...
    onFocusChange: createValueChangedGenericClosure<bool>(
        _inkResponse.buildOwner, onFocusChange),
    autofocus: autofocus,
  ),
  [
    "key",
...
var _inkWell = MXFunctionInvoke(
  ...
  ({
    ...
    canRequestFocus: canRequestFocus,
    onFocusChange: createValueChangedGenericClosure<bool>(
        _inkWell.buildOwner, onFocusChange),
    autofocus: autofocus,
  ),
  [
    "key",
