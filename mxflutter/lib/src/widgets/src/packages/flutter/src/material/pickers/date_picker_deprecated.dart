...
var _dayPicker = MXFunctionInvoke(
    ...
    (
      ...
      selectableDayPredicate: createGenericValueGenericClosure<bool, DateTime>(_dayPicker.buildOwner, selectableDayPredicate),
...
var _monthPicker = MXFunctionInvoke(
    ...
    (
      ...
      firstDate: firstDate,
      lastDate: lastDate,
      selectableDayPredicate: createGenericValueGenericClosure<bool, DateTime>(_monthPicker.buildOwner, selectableDayPredicate),
      dragStartBehavior: dragStartBehavior,
    ),
);
