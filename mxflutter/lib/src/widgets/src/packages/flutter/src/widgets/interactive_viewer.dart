...
var _interactiveViewer = MXFunctionInvoke(
  ...
  ({
    ...
    onInteractionEnd: createValueChangedGenericClosure<ScaleEndDetails>(
        _interactiveViewer.buildOwner, onInteractionEnd),
    onInteractionStart: createValueChangedGenericClosure<ScaleStartDetails>(
        _interactiveViewer.buildOwner, onInteractionStart),
    onInteractionUpdate: createValueChangedGenericClosure<ScaleUpdateDetails>(
        _interactiveViewer.buildOwner, onInteractionUpdate),
