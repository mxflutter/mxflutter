...
let packages__flutter__src__services__platform_channel = require("message_channel/js_flutter_message_channel.js");
...
const platform_channel = packages__flutter__src__services__platform_channel.platform_channel;
...
var _kChannel = dart.privateName(method_channel_shared_preferences, "_kChannel");
...
method_channel_shared_preferences.MethodChannelSharedPreferencesStore = class MethodChannelSharedPreferencesStore extends shared_preferences_platform_interface.SharedPreferencesStorePlatform {
  ...
  [_invokeBoolMethod](method, params) {
    return this[_kChannel].invokeMethod(core.bool, method, params).then(core.bool, dart.fn(result => FutureOrOfbool().as(result), dynamicToFutureOrOfbool()));
  }
  clear() {
    return this[_kChannel].invokeMethod(core.bool, "clear");
  }
  getAll() {
    return this[_kChannel].invokeMapMethod(core.String, core.Object, "getAll");
  }
};
(method_channel_shared_preferences.MethodChannelSharedPreferencesStore.new = function () {
  this[_kChannel] = new platform_channel.MethodChannel.new("plugins.flutter.io/shared_preferences");
  ;
...
dart.setFieldSignature(method_channel_shared_preferences.MethodChannelSharedPreferencesStore, () => ({
  __proto__: dart.getFields(method_channel_shared_preferences.MethodChannelSharedPreferencesStore.__proto__),
  [_kChannel]: dart.fieldType(platform_channel.MethodChannel)
}));
