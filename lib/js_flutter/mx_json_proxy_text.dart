...
class MXProxyTextStyle extends MXJsonObjProxy {
  ...
  TextStyle constructor(MXJsonBuildOwner bo, Map<String, dynamic> jsonMap, {BuildContext context}) {
    ...
    var fontWeight;
    if (fontWeightMap != null && fontWeightMap.containsKey("FontWeight.index")) {
...
class MXTextDecorationStyle  {
	...
	static TextDecorationStyle parse(Map valueMap,{TextDecorationStyle defaultValue }) {
		if(valueMap == null) return defaultValue;
		var valueStr = valueMap["_name"].trim();
		var v = str2VMap[valueStr];
		return v??defaultValue;
...
class MXFontWeight extends MXJsonObjProxy {
  ...
  static Map index2VMap =  {
	...
	@override
	FontWeight constructor(MXJsonBuildOwner bo, Map<String, dynamic> jsonMap, {BuildContext context}) {
...
class MXTextCapitalization  {
	...
	static TextCapitalization parse(Map valueMap,{TextCapitalization defaultValue }) {
		if(valueMap == null) return defaultValue;
		var valueStr = valueMap["_name"].trim();
		var v = str2VMap[valueStr];
		return v??defaultValue;
