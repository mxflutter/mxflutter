...
class MXProxyPlaceholder extends MXJsonObjProxy {
  ...
  @override
  Placeholder constructor(MXJsonBuildOwner bo, Map<String, dynamic> jsonMap, {BuildContext context}) {
    var widget = Placeholder(
      key: mxj2d(bo, jsonMap["key"]),
      color:mxj2d(bo, jsonMap["color"],defaultValue:const Color(0xFF455A64)),
      strokeWidth:mxj2d(bo, jsonMap["strokeWidth"],defaultValue: 2.0)?.toDouble(),
      fallbackWidth:mxj2d(bo, jsonMap["fallbackWidth"],defaultValue: 400.0)?.toDouble(),
      fallbackHeight:mxj2d(bo, jsonMap["fallbackHeight"],defaultValue: 400.0)?.toDouble(),
    );
    return widget;
  }
}
