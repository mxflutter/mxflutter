...
class MXHitTestBehavior {
  static HitTestBehavior parse(String value, {HitTestBehavior defaultValue = HitTestBehavior.deferToChild}) {
    HitTestBehavior retValue = defaultValue;

    switch (value) {
      case 'HitTestBehavior.deferToChild':
        retValue = HitTestBehavior.deferToChild;
        break;
      case 'HitTestBehavior.opaque':
        retValue = HitTestBehavior.opaque;
        break;
      case 'HitTestBehavior.translucent':
        retValue = HitTestBehavior.translucent;
        break;
      default:
