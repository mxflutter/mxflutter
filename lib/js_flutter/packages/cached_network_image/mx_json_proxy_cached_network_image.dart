...
class MXProxyCachedNetworkImage extends MXJsonObjProxy {
	static Map<String, CreateJsonObjProxyFun> registerProxy() {
		...
		///**@@@  3 替换类构造函数
		return {regClassName: () => MXProxyCachedNetworkImage()..init(className: regClassName)};
	}

	@override
	CachedNetworkImage constructor(MXJsonBuildOwner bo, Map<String, dynamic> jsonMap, {BuildContext context}) {
