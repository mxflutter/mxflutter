...
class MXProxyCupertinoActivityIndicator extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoActivityIndicator()..init(className: regClassName)};
  }
  ///*********************************************************************
...
class MXProxyCupertinoAlertDialog extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoAlertDialog()..init(className: regClassName)};
  }
  ///*********************************************************************
...
class MXProxyCupertinoButton extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoButton()..init(className: regClassName)};
  }
...
class MXProxyCupertinoDialog extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoDialog()..init(className: regClassName)};
  }
  ///*********************************************************************
...
class MXProxyCupertinoDialogAction extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoDialogAction()..init(className: regClassName)};
  }
  ///*********************************************************************
  ...
  CupertinoDialogAction constructor(MXJsonBuildOwner bo,Map<String, dynamic> jsonMap) {
    var widget = CupertinoDialogAction(
      ...
      isDestructiveAction: mxj2d(bo,jsonMap["isDestructiveAction"],defaultValue: false),
...
class MXProxyCupertinoSlider extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoSlider()..init(className: regClassName)};
  }
  ///*********************************************************************
...
class MXProxyCupertinoSwitch extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoSwitch()..init(className: regClassName)};
  }
  ///*********************************************************************
...
class MXProxyCupertinoPageTransition extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoPageTransition()..init(className: regClassName)};
  }
  ///*********************************************************************
...
class MXProxyCupertinoNavigationBar extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoNavigationBar()..init(className: regClassName)};
  }
  ///*********************************************************************
...
///  })
  ...
  CupertinoNavigationBar constructor(MXJsonBuildOwner bo,Map<String, dynamic> jsonMap) {
    ...
    var widget = CupertinoNavigationBar(
      ...
      automaticallyImplyMiddle: mxj2d(bo,jsonMap["automaticallyImplyMiddle"],defaultValue: true),
      ...
      transitionBetweenRoutes: mxj2d(bo,jsonMap["transitionBetweenRoutes"],defaultValue: true),
...
class MXProxyCupertinoTabBar extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoTabBar()..init(className: regClassName)};
  }
  ///*********************************************************************
...
class MXProxyCupertinoPageScaffold extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoPageScaffold()..init(className: regClassName)};
  }
  ///*********************************************************************
...
class MXProxyCupertinoTabScaffold extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoTabScaffold()..init(className: regClassName)};
  }
  ///*********************************************************************
...
class MXProxyCupertinoTabView extends MXJsonObjProxy {
  ...
  static  Map<String, CreateJsonObjProxyFun> registerProxy(){
    ...
    ///**@@@  3 替换类构造函数
    return {regClassName: ()=>MXProxyCupertinoTabView()..init(className: regClassName)};
  }
  ///*********************************************************************
