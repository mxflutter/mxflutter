...
class MXFJSBridge {
  ...
  ///js->native->flutter 顶层通用调用通道
  static invokeFlutterCommonChannel({basicMethodCall,needNativeManagedValue, callback}) {
    mxfJSBridgeInvokeFlutterCommonChannel(basicMethodCall.encodeJSON(), needNativeManagedValue,function (result) {
  ...
  static createMirrorObj(flutterCallArgs,needNativeManagedValue) {

    let basicMethodCall = new MXMethodCall("mxfJSBridgeCreateMirrorObj", flutterCallArgs);
    MXFJSBridge.invokeFlutterCommonChannel({basicMethodCall,needNativeManagedValue});
