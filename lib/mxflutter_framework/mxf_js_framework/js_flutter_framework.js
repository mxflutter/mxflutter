...
function createFlutterObject(flutterCallArgs) {
  arguments = JSON.stringify(flutterCallArgs);
  mx_jsbridge_createFlutterObject(arguments);
}

class MXBasicMethodCall{
...
function invokeFlutterFunctionWithCallback(flutterCallArgs, onResult) {
  // arguments = JSON.stringify(flutterCallArgs);
  // mx_jsbridge_invokeWithCallback(arguments, onResult);

  MXBasicMethodCall("mxflutterBridgeInvokeWithCallback",);


}

function callFlutterCommonChannel(flutterCallArgs, onResult) {
  mx_jsbridge_call_flutter_common_channel(flutterCallArgs, onResult);
}
...
module.exports = {
  runApp,
  createFlutterObject,
  invokeFlutterFunctionWithCallback,
