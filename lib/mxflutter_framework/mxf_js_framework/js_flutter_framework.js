...
class MXFJSBridge {
  ...
  static invokeFlutterCommonChannel(basicMethodCall, callback) {
    mxfJSBridgeInvokeFlutterCommonChannel(basicMethodCall.encodeJSON(), function (result) {
      ...
      MXJSLog.debug("callFlutterCommonChannel: callback: " + result);
    });
  }
  ...
  static createMirrorObj(flutterCallArgs) {

    let basicCall = new MXMethodCall("mxfJSBridgeCreateMirrorObj", flutterCallArgs);
    MXFJSBridge.invokeFlutterCommonChannel(basicCall);

  }

  static invokeMirrorObjWithCallback(flutterCallArgs, callback) {

    let basicCall = new MXMethodCall("mxfJSBridgeInvokeMirrorObjWithCallback", flutterCallArgs);
    MXFJSBridge.invokeFlutterCommonChannel(basicCall, callback);
  }
