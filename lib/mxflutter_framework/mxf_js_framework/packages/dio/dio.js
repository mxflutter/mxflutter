...
class MXResponse extends DartClass {
    ...
    static fromJSON(jsonMap) {
        ...
        this.headers = new MXHeaders(jsonMap["headers"]);
        this.request = jsonMap["request"];
        this.isRedirect = jsonMap["isRedirect"];
        this.statusCode = jsonMap["statusCode"];
        this.statusMessage = jsonMap["statusMessage"];
        this.redirects = jsonMap["redirects"];
        this.extra = jsonMap["extra"];
    }
}
